...
name: feature-dev
description: |
  Use when implementing a feature that touches multiple files or modules.
  Triggers: "implement feature", "build this", "add this functionality", any multi-file change.
  7 phases. No code before Phase 5. No exceptions.
---
