#!/usr/bin/env python3
"""
Token Usage Tracker (Stop event)
Appends a JSONL record to .claude/token-usage.jsonl in the project directory.
...
LOG_FILENAME = os.path.join(".claude", "token-usage.jsonl")
...
def main():
    ...
    project_dir = os.environ.get(
        "CLAUDE_PROJECT_DIR",
        os.environ.get("CURSOR_WORKSPACE_PATH", os.getcwd()),
    )
