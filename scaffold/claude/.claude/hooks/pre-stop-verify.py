...
def session_appears_verified(project_dir, config_dir):
    ...
    Looks for VERIFIED marker in session notes (written by work-verifier or verify skill).
...
def main():
    ...
    print(
        ...
        "Consider running /ship or invoking the work-verifier agent before closing.\n"
        "To run verification only: use the work-verifier agent directly.",
        file=sys.stderr,
    )
