...
description: Use when creating or applying database migrations. Triggers: "create migration", "add column", "schema change", "database migration", "run migration". Validates safety before running. Generates rollback SQL. Blocks dangerous ops without confirmation.
---
