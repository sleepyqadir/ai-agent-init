---
name: api-design
description: Use when adding new API endpoints or changing existing ones. Triggers: "add endpoint", "new API route", "create endpoint", "API for", "REST endpoint". Designs the contract before any implementation. Nothing gets built until contract is approved.
---
