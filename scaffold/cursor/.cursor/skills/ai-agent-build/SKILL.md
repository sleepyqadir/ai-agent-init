---
name: ai-agent-build
description: Use when building AI agents, LLM pipelines, or multi-agent systems. Triggers: "build an agent", "create AI pipeline", "LLM workflow", "agent system", "multi-agent". Forces evaluation definition BEFORE implementation. Covers orchestration, cost, and reliability.
---
